//https://github.com/nkapliev/google-foo.bar/blob/master/problems/4.1_bringing_a_gun_to_a_guard_fight.py
...
def solution(dimensions, captain_position, badguy_position, distance):
